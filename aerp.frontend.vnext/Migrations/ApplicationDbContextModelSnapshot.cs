...
using aerp.frontend.vnext.Models;

namespace aerp.frontend.vnext.Migrations
{
    [ContextType(typeof(aerp.frontend.vnext.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("aerp.frontend.vnext.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("aerp.frontend.vnext.Models.ApplicationUser", "UserId");
                });
